        ...
        injectedJavaScript={`
          (function() {
            ...
            try {
              ...
              // TEMPORARY DIAGNOSTIC — scrolling is confirmed broken again despite
              // unchanged code, even on a fresh install. Likely the live site's own DOM
              // changed since this was last confirmed working. Report every fixed/sticky
              // element found (regardless of whether it passes the filter) to see what's
              // actually there now. Remove once resolved.
              setTimeout(function() {
                var lines = [];
                var all = document.body.getElementsByTagName('*');
                var count = 0;
